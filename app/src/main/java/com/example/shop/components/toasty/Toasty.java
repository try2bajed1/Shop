package com.example.shop.components.toasty;
...
public class Toasty {
    ...
    private static final @ColorInt int ERROR_COLOR = Color.parseColor("#F44336");
    private static final @ColorInt int INFO_COLOR = Color.parseColor("#3F51B5");
    private static final @ColorInt int SUCCESS_COLOR = Color.parseColor("#8BC34A");
